...
###############################################################################
#EduProps_3<-read.csv2("C:/Users/svill/Desktop/mg/1_thesis/results/real_data_2/EduProps_3.csv")
...
prob.n<-c(11051,1365,1128,845,684,683,336,448,329,264,60)
prob3[[1]]<-NULL
...
nonprob_est_prop<-round(nonprob_est_prop,digits=2)
write.xlsx(nonprob_est_prop,file="nonprob3.xlsx")
...
c.est.function<-function(k,c,n.pk,n.npk,prob.table,nonprob.table,nonprob_est_prop,prob_est_prop){
  ...
  bc<-matrix(colMeans(nonprob_est_prop-prob_est_prop),nrow=k,ncol=c,byrow=T) #
  ...
  wkc<-((n.npk-1)*(bc^2+new.sigma)+v.kc)/((n.npk-1)*(1-1/n.pk)*(bc^2+new.sigma)+(1+n.npk/n.pk)*v.kc+((n.npk-1)/n.pk)*bc*(2*nonprob.table-1))
  wkc[wkc<0]<-0
  wkc[wkc>1]<-1
...
comb1<-c.est.function(1,3,n.pk1,n.npk1,kp1,knp1,nonprob_est_prop,prob3)
comb2<-c.est.function(1,3,n.pk2,n.npk2,kp2,knp2,nonprob_est_prop,prob3)
comb3<-c.est.function(1,3,n.pk3,n.npk3,kp3,knp3,nonprob_est_prop,prob3)
comb4<-c.est.function(1,3,n.pk4,n.npk4,kp4,knp4,nonprob_est_prop,prob3)
comb5<-c.est.function(1,3,n.pk5,n.npk5,kp5,knp5,nonprob_est_prop,prob3)
comb6<-c.est.function(1,3,n.pk6,n.npk6,kp6,knp6,nonprob_est_prop,prob3)
comb7<-c.est.function(1,3,n.pk7,n.npk7,kp7,knp7,nonprob_est_prop,prob3)
comb8<-c.est.function(1,3,n.pk8,n.npk8,kp8,knp8,nonprob_est_prop,prob3)
comb9<-c.est.function(1,3,n.pk9,n.npk9,kp9,knp9,nonprob_est_prop,prob3)
comb10<-c.est.function(1,3,n.pk10,n.npk10,kp10,knp10,nonprob_est_prop,prob3)
comb11<-c.est.function(1,3,n.pk11,n.npk11,kp11,knp11,nonprob_est_prop,prob3)

combined_estimator<-rbind(comb1,comb2,comb3,comb4,comb5,comb6,comb7,comb8,comb9,comb10,comb11) 

combined_estimator<-round(combined_estimator,digits=2)
write.xlsx(combined_estimator,file="combined_estimator.xlsx")
...
comb1<-c.est.function(1,3,n.pk1,n.npk1,kp1,knp1,nonprob_est_prop,prob_est_prop1)
comb2<-c.est.function(1,3,n.pk2,n.npk2,kp2,knp2,nonprob_est_prop,prob_est_prop1)
comb3<-c.est.function(1,3,n.pk3,n.npk3,kp3,knp3,nonprob_est_prop,prob_est_prop1)
comb4<-c.est.function(1,3,n.pk4,n.npk4,kp4,knp4,nonprob_est_prop,prob_est_prop1)
comb5<-c.est.function(1,3,n.pk5,n.npk5,kp5,knp5,nonprob_est_prop,prob_est_prop1)
comb6<-c.est.function(1,3,n.pk6,n.npk6,kp6,knp6,nonprob_est_prop,prob_est_prop1)
comb7<-c.est.function(1,3,n.pk7,n.npk7,kp7,knp7,nonprob_est_prop,prob_est_prop1)
comb8<-c.est.function(1,3,n.pk8,n.npk8,kp8,knp8,nonprob_est_prop,prob_est_prop1)
comb9<-c.est.function(1,3,n.pk9,n.npk9,kp9,knp9,nonprob_est_prop,prob_est_prop1)
comb10<-c.est.function(1,3,n.pk10,n.npk10,kp10,knp10,nonprob_est_prop,prob_est_prop1)
comb11<-c.est.function(1,3,n.pk11,n.npk11,kp11,knp11,nonprob_est_prop,prob_est_prop1)

c1<-c.est.function(1,3,xn.pk1,n.npk1,xkp1,knp1,nonprob_est_prop,prob_est_prop2)
c2<-c.est.function(1,3,xn.pk2,n.npk2,xkp2,knp2,nonprob_est_prop,prob_est_prop2)
c3<-c.est.function(1,3,xn.pk3,n.npk3,xkp3,knp3,nonprob_est_prop,prob_est_prop2)
c4<-c.est.function(1,3,xn.pk4,n.npk4,xkp4,knp4,nonprob_est_prop,prob_est_prop2)
c5<-c.est.function(1,3,xn.pk5,n.npk5,xkp5,knp5,nonprob_est_prop,prob_est_prop2)
c6<-c.est.function(1,3,xn.pk6,n.npk6,xkp6,knp6,nonprob_est_prop,prob_est_prop2)
c7<-c.est.function(1,3,xn.pk7,n.npk7,xkp7,knp7,nonprob_est_prop,prob_est_prop2)
c8<-c.est.function(1,3,xn.pk8,n.npk8,xkp8,knp8,nonprob_est_prop,prob_est_prop2)
c9<-c.est.function(1,3,xn.pk9,n.npk9,xkp9,knp9,nonprob_est_prop,prob_est_prop2)
c10<-c.est.function(1,3,xn.pk10,n.npk10,xkp10,knp10,nonprob_est_prop,prob_est_prop2)
c11<-c.est.function(1,3,xn.pk11,n.npk11,xkp11,knp11,nonprob_est_prop,prob_est_prop2)
...
combined_big_sample<-round(combined_big_sample,digits=2)
write.xlsx(combined_big_sample,file="combined_big_sample.xlsx")
combined_small_sample<-round(combined_small_sample,digits=2)
write.xlsx(combined_small_sample,file="combined_small_sample.xlsx")