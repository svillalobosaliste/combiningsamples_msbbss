...
#can be run with the first part of this script (until line 85)and the 12 elements 
#of the list will be stored.

#From line 87, the results to be analyzed are computed: Mean of the ARMSE
#per domain and mean absolute bias per domain

#The output of this script are found of the folder "Scripts" and is 6 RSD files 
#needed to replicate the results produced by scripts 3 and 4.
