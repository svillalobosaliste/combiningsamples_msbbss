...
################################################
#### SPLIT COND_EQ AND COND_UNEQ PER MODEL #####
################################################
...
#####   IS LOWER THAN: PROBABILITU SAMPLE,   #####
...
#################################################
## This is the positions vectors that the armse.comb should have 
#in the final MARMSE tables
...
#With this function the column armse.comb is read and creates a table with
#the position specified in the vectors (row1-row16)
...
#This function reads the column color and creates a table in the same order than the
#Marmse tables
...
###################
#This functions reads the column of the armse of the probability sample and creates a table with
#the position specified in the vectors (row1-row16)
...
#This functions reads the column of the armse of the non-probability sample and creates a table with
#the position specified in the vectors (row1-row16)
