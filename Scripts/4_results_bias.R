...
#FILES NEEDED: bias_eq_1.rds, bias_eq_2.rds, bias_uneq_1,rds, bias_uneq_2.rds
...
##################################################################### 
## This is the positions vectors that the bias should have 
#in the final table 
...
#With this function the column diff is read and creates a table with
...
#With this function the column bias.comb is read and creates a table with
#the position specified in the vectors (row1-row16)
